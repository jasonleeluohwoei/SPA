...
?>
	...
	<head>
		...
		<title>Smart Power Auto | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-number h1 "><?php //echo htmlentities($bookings);
																						?></div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-number h1 "><?php echo htmlentities($brands);
																							?></div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-primary text-light">
													<div class="stat-panel text-center">
														...
														$subscribers = $query4->rowCount();
														?>
														<div class="stat-panel-number h1 "><?php //echo htmlentities($subscribers); 
																							?></div>
														<div class="stat-panel-title text-uppercase">Subscibers</div>
													</div>
												</div>
 ...
 <?php
	...
	?>
													 ...
													 <div class="stat-panel-number h1 "><?php //echo htmlentities($testimonials);
																						?></div>

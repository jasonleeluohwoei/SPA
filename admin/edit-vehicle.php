...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if(isset($_POST['submit'])&& ($_POST['saletype']) == 'Rental')
  {
	...
	FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,VehiclesPlate=:vehicleplate,VehiclesMileage=:vehiclemileage,AirConditioner=:airconditioner,
